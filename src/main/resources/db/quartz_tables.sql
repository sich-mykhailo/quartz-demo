...
(
    ID BIGINT constraint "PK_job_info" primary key,
    JOB_NAME  VARCHAR(200)  NULL,
    JOB_GROUP  VARCHAR(200) NULL,
    ...
    CRON_JOB BOOLEAN  null
);

-- auto-generated definition
create sequence scheduler_job_info_id_seq;

alter sequence scheduler_job_info_id_seq owner to postgres;

alter sequence scheduler_job_info_id_seq owned by scheduler_job_info.id;
